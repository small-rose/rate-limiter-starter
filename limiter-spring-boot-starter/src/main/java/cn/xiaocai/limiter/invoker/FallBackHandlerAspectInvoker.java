package cn.xiaocai.limiter.invoker;

import cn.xiaocai.limiter.annotation.ExceptionFallBack;
import cn.xiaocai.limiter.fallback.ExceptionFallBackHandler;
import cn.xiaocai.limiter.fallback.ruls.FallBackRule;
import cn.xiaocai.limiter.fallback.ruls.NoFallBackRule;
 ...
 * @version: v1.0
 */
public class FallBackHandlerAspectInvoker implements HandlerAspectInvoker {

    private static final FallBackHandlerAspectInvoker INSTANCE = new FallBackHandlerAspectInvoker();

    private FallBackHandlerAspectInvoker() {
    }

    public static FallBackHandlerAspectInvoker getInstance() {
        return INSTANCE;
    }
