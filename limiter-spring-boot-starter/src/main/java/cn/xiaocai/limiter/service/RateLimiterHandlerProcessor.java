...
import cn.xiaocai.limiter.annotation.RateLimitFCL;
import cn.xiaocai.limiter.annotation.RateLimitSWL;
import cn.xiaocai.limiter.annotation.RateLimitTBL;
...
public class RateLimiterHandlerProcessor implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        Map<String, Object> beanList = applicationContext.getBeansWithAnnotation(Controller.class);
        beanList.putAll(applicationContext.getBeansWithAnnotation(RestController.class));
