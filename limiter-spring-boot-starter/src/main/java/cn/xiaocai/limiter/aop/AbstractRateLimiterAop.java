package cn.xiaocai.limiter.aop;

import cn.xiaocai.limiter.exception.LimitConflictException;
import cn.xiaocai.limiter.interceptor.RateLimitGlobalInterceptor;
import cn.xiaocai.limiter.interceptor.RateLimitInterceptor;
import cn.xiaocai.limiter.invoker.RateLimitHandlerAspectInvoker;
...
*/
    ...
    @Pointcut(value = "@annotation(cn.xiaocai.limiter.annotation.RateLimitSWL)")
    public void SWLLimitInterceptor(){};

    @Pointcut(value = "@annotation(cn.xiaocai.limiter.annotation.RateLimitFCL)")
    public void FCLLimitInterceptor(){};

    @Pointcut(value = "@annotation(cn.xiaocai.limiter.annotation.RateLimitTBL)")
    public void TBLLimitInterceptor(){};

    @Pointcut(value = "@annotation(cn.xiaocai.limiter.annotation.RateLimitLBL)")
